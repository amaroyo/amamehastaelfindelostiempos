...
// CONTENIDO DEL FICHERO CALENDAR-ES.JS
...
"- s pulse las mayusculas mientras hace clic para decrementarla\n" +
"- s haga clic y arrastre el ratón para una selección mas rapida.";
...
//CONTENIDO DEL FICHERO CALENDARIO.JS
var oldLink = null;
...
function showCalendarForm(formulario, id, format, showsTime) {
  //var el = document.getElementById(id);
  var el = document.forms[formulario][id];
  if (calendar != null) {
