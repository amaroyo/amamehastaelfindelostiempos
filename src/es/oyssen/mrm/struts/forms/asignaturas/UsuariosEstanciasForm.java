...
public class UsuariosEstanciasForm extends DhtmlxForm {
	...
	public String getIdEstanciaUnidad() {
		return idEstanciaUnidad;
	}
	public void setIdEstanciaUnidad(String idEstanciaUnidad) {
		this.idEstanciaUnidad = idEstanciaUnidad;
	}
