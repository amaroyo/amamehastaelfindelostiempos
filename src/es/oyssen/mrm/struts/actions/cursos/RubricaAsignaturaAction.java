...
public class RubricaAsignaturaAction extends MrmAction {
	...
	public String parseXML(Object o) throws Exception {
		...
		if (o != null){
			...
			sb.append("<competencias><![CDATA[" + rubrica.getCompetencias() + "]]></competencias>");
			sb.append("<numero_criterios><![CDATA[" + rubrica.getNumeroCriterios() + "]]></numero_criterios>");
