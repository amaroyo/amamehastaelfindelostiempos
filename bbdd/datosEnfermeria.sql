...
-- Permisos
-- Solo el primero modificado por el momento
insert into permisos (nombre, descripcion) values ('Todas las acciones permitidas', 'El administrador tendrá todos los privilegios');
