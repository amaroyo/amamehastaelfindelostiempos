...
DROP TABLE IF EXISTS usuarios_pendientes_registro;
...
DROP TABLE IF EXISTS profesores asociados;
...
CREATE TABLE IF NOT EXISTS grupos (
	id_grupo INT(3) NOT NULL auto_increment PRIMARY KEY,  
...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  id_grupo INT(3) NOT NULL FOREIGN KEY REFERENCES grupos(id_grupo),
