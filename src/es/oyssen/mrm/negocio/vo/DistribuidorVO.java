...
public class DistribuidorVO {
	...
	public DistribuidorVO(String id, String nombre) {
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((idDistribuidor == null) ? 0 : idDistribuidor.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DistribuidorVO other = (DistribuidorVO) obj;
		if (idDistribuidor == null) {
			if (other.idDistribuidor != null)
				return false;
		} else if (!idDistribuidor.equals(other.idDistribuidor))
			return false;
		return true;
	}
