...
import es.oyssen.mrm.struts.forms.servicios.GridServiciosForm;
...
public class GridLeadsAction extends DHTMLXGridWithRequestAction {
	...
	public String search(DhtmlxGridForm f, HttpServletRequest request) throws Exception {
		GridServiciosForm form = (GridServiciosForm) f;		
		CriterioLeadVO criterio = new CriterioLeadVO();
		criterio.setServicio(form.getIdServicio());
		...
		return UtilXML.buildXmlGridLeadsServicios(leads);
	}
