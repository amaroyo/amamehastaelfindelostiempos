...
public class ComercialMapper implements RowMapper {

	public static final String FIELD_ID = "id_comercial";
    ...
    public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
    	ComercialVO o = new ComercialVO();
    	o.setIdComercial(StringUtil.nullToString(rs.getString(FIELD_ID)));
