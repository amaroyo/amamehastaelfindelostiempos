...
public abstract class DHTMLXGridWithRequestAction extends MrmAction {
	...
	public ActionForward process(ActionMapping mapping, ActionForm form,
		...
		if (!StringUtil.isNullOrBlank(f.getNativeeditor_status())) {
			...
			writeGridXML(response, search(f, request));
		}
	...
	public abstract String search(DhtmlxGridForm f, HttpServletRequest request) throws Exception;
