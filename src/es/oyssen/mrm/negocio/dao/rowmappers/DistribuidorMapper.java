...
public class DistribuidorMapper implements RowMapper {

	public static final String FIELD_ID = "id_distribuidor";
	public static final String FIELD_ID_CANAL = "id_canal";
    ...
    public static final String FIELD_BLOQUEADO = "bloqueado";
    
    public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
    	DistribuidorVO o = new DistribuidorVO();
    	o.setIdDistribuidor(StringUtil.nullToString(rs.getString(FIELD_ID)));
    	o.setIdCanal(StringUtil.nullToString(rs.getString(FIELD_ID_CANAL)));
    	...
    	o.setBloqueado(StringUtil.nullToString(rs.getString(FIELD_BLOQUEADO)));
